...
void DrawLine(const Vector3& v1, const Vector3& v2, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix, uint32_t color) {
	Vector3 newV1 = Transform(Transform(v1, viewProjectionMatrix), viewportMatrix);
	Vector3 newV2 = Transform(Transform(v2, viewProjectionMatrix), viewportMatrix);
	Novice::DrawLine(int(newV1.x), int(newV1.y), int(newV2.x), int(newV2.y), color);
}
...
void DrawBezier(const Vector3& controlPoint0, const Vector3& controlPoint1, const Vector3& controlPoint2,
	...
	for (int i = 0; i < subdivision; i++) {
		...
		DrawLine(bezier0[i], bezier1[i], viewProjectionMatrix, viewportMatrix, color);
...
void DrawCatmullRom(const Vector3& controlPoint0, const Vector3& controlPoint1, const Vector3& controlPoint2, const Vector3& controlPoint3,
	...
	Vector3 catmull0[subdivision];
	Vector3 catmull1[subdivision];
	...
	for (int i = 0; i < subdivision; i++) {
		...
		catmull0[i] = CatmullRom(controlPoint0, controlPoint1, controlPoint2, controlPoint3, t0);
		catmull1[i] = CatmullRom(controlPoint0, controlPoint1, controlPoint2, controlPoint3, t1);
		

		DrawLine(catmull0[i], catmull1[i], viewProjectionMatrix, viewportMatrix, color);
...
void DrawSphere(const Sphere& sphere, const Matrix4x4& viewProjectionMatrix, const Matrix4x4& viewportMatrix, uint32_t color) {
	...
	for (uint32_t latIndex = 0; latIndex < kSubdivision; ++latIndex) {
		...
		for (uint32_t lonIndex = 0; lonIndex < kSubdivision; ++lonIndex) {
			...
			DrawLine(a, b, viewProjectionMatrix, viewportMatrix, color);//LineAB
			DrawLine(a, c, viewProjectionMatrix, viewportMatrix, color);//LineAC
		}
	}
}
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		ImGui::DragFloat3("controlPoint[3]", &controlPoint[3].x, 0.01f);
		ImGui::End();
		...
		DrawCatmullRom(controlPoint[0], controlPoint[1], controlPoint[2], controlPoint[3], worldViewProjectionMatrix, viewportMatrix, BLUE);
